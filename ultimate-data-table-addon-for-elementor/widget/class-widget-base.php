...
abstract class Ultimate_Data_Table_Widget_Base extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->register_extra_style_sections();
        $this->register_row_column_style_section();
        $this->register_search_style_section();
    ...
    /**
     * Extension point: Pro adds its Image / Icon / Read More Button style sections here,
     * between the Table Body style section and the Row/Column style section.
     */
    protected function register_extra_style_sections() {}

    /**
     * Extension point: Pro adds the .cell-inner flex popover controls here,
     * between body_border_color and body_cells_padding.
     */
    protected function register_body_style_extra_controls() {}

    protected function get_body_cells_padding_label() {
        return esc_html__( 'Cell Padding', 'ultimate-data-table-addon-for-elementor' );
    }

    /**
     * Repeater key used to render the <td> tag's own attributes (colspan/rowspan/class).
     */
    protected function get_body_cell_td_render_key( $index ) {
        return $this->get_repeater_setting_key( 'text', 'table_body', $index );
    }

    /**
     * Repeater key used for add_inline_editing_attributes() on the cell's editable text.
     */
     ...
     */
    protected function render_body_cell_content( $item, $index ) {
    ...
    protected function register_body_content_section() {
        // Body Content Start
        $this->start_controls_section(
            'content_table_body',
            [
    ...
    protected function register_configuration_section() {
    ...
    protected function register_header_style_section() {
        // Header Style Start
        $this->start_controls_section(
            'table_header_style',
            [
    ...
    protected function register_body_style_section() {
        // Body Style Start
        $this->start_controls_section(
            'table_body_style',
            [
            ...
            $this->register_body_style_extra_controls();
            $this->add_responsive_control(
                'body_cells_padding',
                [
                    'label' => $this->get_body_cells_padding_label(),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => [ 'px', '%', 'em', 'custom' ],
                    'selectors' => [
    ...
    protected function register_row_column_style_section() {
    ...
    protected function register_search_style_section() {
        // Search Style Start
        $this->start_controls_section(
            'search_style',
            [
    ...
    protected function register_entries_dropdown_style_section() {
    ...
    protected function register_info_style_section() {
        // Info Style Start
        $this->start_controls_section(
            'tableinfo_style',
            [
            ...
            <table id="<?php echo esc_attr( 'ultimate-datatable-' . $unique ); ?>">
                ...
                <tbody class="ultimate-data-table-body">
                    ...
                    foreach ($settings['table_body'] as $index => $item) {
                        ...
                        $table_body_key = $this->get_body_cell_td_render_key( $index );
                        $this->add_inline_editing_attributes( $this->get_body_cell_editing_key( $index ) );
